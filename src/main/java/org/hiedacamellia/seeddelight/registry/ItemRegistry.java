...
public class ItemRegistry {
    ...
    public static Item.Properties basicItem() {
        return new Item.Properties().tab(SeedDelight.SeedDelightTab);
    }
//Helper
    public static Item.Properties foodItem(FoodProperties food) {
        return new Item.Properties().food(food).tab(SeedDelight.SeedDelightTab);
    }

    public static Item.Properties bowlFoodItem(FoodProperties food) {
        return new Item.Properties().food(food).craftRemainder(Items.BOWL).stacksTo(16).tab(SeedDelight.SeedDelightTab);
    }

    public static Item.Properties drinkItem() {
        return new Item.Properties().craftRemainder(Items.GLASS_BOTTLE).stacksTo(16).tab(SeedDelight.SeedDelightTab);
    }
//Registry
